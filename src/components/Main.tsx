const Main = () => {
  return (
   <>
   <main className="flex-1 relative flex items-center justify-center pr-6 pl-1  md:pr-6  py-20 overflow-hidden" style={{ background: 'var(--theme-bg)', color: 'var(--theme-text)' }}>
